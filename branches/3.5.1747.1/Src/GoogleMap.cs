...
namespace ZimWeb.Web.UI
{
    ...
    public class GoogleMap : CompositeControl
    {
        ...
        protected override void CreateChildControls()
        {
            ...
            string toherefunction = string.Empty;
            string getdirection = string.Empty;
            string maplocationclick = string.Empty;
            string setXmlFile = string.Empty;
            ...
            if (Page != null)
            {
                ...
                //add the key
                string googleInclude = "http://maps.google.com/maps?file=api&v=2&key=" + this.GoogleKey;
