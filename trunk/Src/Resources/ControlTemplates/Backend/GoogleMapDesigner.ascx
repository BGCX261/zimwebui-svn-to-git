...
<sfCntl:CssFileLink runat="server" ID="css1" FileName="" EmbeddedFileName="ZimWeb.Web.UI.Resources.ControlTemplates.Backend.GoogleMapDesigner.css" ></sfCntl:CssFileLink>
<div class="ctrlProps">
        ...
        <div class="ctrlContentImage">
            <div class="ctrlContentImageColumn">
                ...
                <p>
                    ...
                    <asp:DropDownList ID="Zoom" runat="server"></asp:DropDownList>
                </p>
                <p>
                    <asp:Label ID="Label5" AssociatedControlID="EnableDirections" runat="server" Text='<%$Resources:EnableDirections %>'></asp:Label>
                    <asp:CheckBox ID="EnableDirections" runat="server"></asp:CheckBox>
                </p>
                <asp:LinkButton ID="UpdateMap" runat="server" CssClass="CmsButLeft light">
                    <strong class="CmsButRight light">
                        <asp:Literal ID="Literal3" runat="server" Text='<%$Resources:UpdateMap %>'></asp:Literal></strong></asp:LinkButton>
            </div>
            <div class="ctrlContentImageColumn">
